...
#all_bg_files = glob.glob("./BG_B11/BG_*L/*.csv")
#all_bg_files = glob.glob("./BG_B13/BG_*L/*.csv")
#all_bg_files = glob.glob("./BG_B22/BG_*L/*.csv")
#all_bg_files = glob.glob("./BG_MBIN1/BG_*L/*.csv")
#all_bg_files = glob.glob("./BG_B14/BG_*L/*.csv")
#all_bg_files = glob.glob("./BG_B15/BG_*L/*.csv")
#all_bg_files = glob.glob("./BG_B16/BG_*L/*.csv")
all_bg_files = glob.glob("./BG_B17/BG_*L/*.csv")
...
print("Bins with Yield 0.1< Yield <1 ?")
...
print("Bins with Yield < 0.1 ?")
allbgframe = allbgframe.loc[ ((allbgframe['Yield']<0.1)) ]
allbgframe['Yield']=allbgframe['Yield'].round(5)
print(allbgframe.shape)
print(allbgframe)
